...
[![Build Status](https://github.com/Best-Quality-Engineering/ci-maven-plugin/actions/workflows/deploy-ossrh-snapshot.yml/badge.svg)](https://github.com/Best-Quality-Engineering/ci-maven-plugin/actions/workflows/deploy-ossrh-snapshot.yml)
[![Release Status](https://github.com/Best-Quality-Engineering/ci-maven-plugin/actions/workflows/deploy-ossrh-release.yml/badge.svg)](https://github.com/Best-Quality-Engineering/ci-maven-plugin/actions/workflows/deploy-ossrh-release.yml)
...
## Example Uses
This project is built using the plugin, see the [Contribution Guidelines](./CONTRIBUTING.md) for more details.